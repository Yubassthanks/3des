...
INSERT INTO `Cardapio` (`produto`, `descricao`, `preco`)
VALUES 
    ('Pizza Margherita', 'Traditional Neapolitan pizza with tomato, mozzarella, and basil', 12.99),
    ('Chicken Alfredo Pasta', 'Creamy pasta with grilled chicken and Alfredo sauce', 10.99),
    ('Cheeseburger', 'Juicy beef patty with cheese, lettuce, and tomatoes', 8.49),
    ('Caesar Salad', 'Fresh romaine lettuce with Caesar dressing and croutons', 6.99);
